...
L["Confirm Edit"] = "手动设置"
L["Reset Edit"] = "系统预估"
L["Must be an integer greater than zero"] = "请输入大于零的整数"
...
L["Delete all collected data"] = "删除所有收集的数据，包括黑名单和玩家池大小记录"
L["Remove repeat data"] = "移除重复数据"
L["Remove corrupt data"] = "移除异常数据"
L["Remove all corrupt data"] = "已从本地数据库中移除所有异常的荣誉数据，并且将其拉入临时黑名单不再接收其他插件广播，除非得到一个更新的准确数据。建议手动在聊天框输入 /reload 重载插件。"
L["Requires more than 500 data table records"] = "需要数据表中上周排名大于 0 的玩家记录超过 500 条时才可以执行本操作，数据较少时执行此操作可能会出现问题。"
L["Limit Rows"] = "行数限制"
...
L["Today Kills"] = "今日击杀次数"
L["Estimated Honor"] = "荣誉预估"
L["Estimated Standing"] = "排名预估"
